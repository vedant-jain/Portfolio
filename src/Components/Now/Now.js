    ...
    render() {
        return (
            <div className = "Now">
                ...
                <p>I've recently moved to bangalore 🇮🇳</p>
                <p>trying to read 50 books this year <span id="emoji">🥵</span></p>
                ...
                <p>getting into de-fi...but I'm pretty wary of it lol</p>
                ...
                <p>btw this is from January 11</p>
